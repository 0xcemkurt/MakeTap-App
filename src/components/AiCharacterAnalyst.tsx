...
export const AiCharacterAnalyst: React.FC<AiCharacterAnalystProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
      {/* Header Banner */}
      <div className="bg-gradient-to-br from-indigo-700 via-brand-700 to-sky-600 rounded-2xl p-5 sm:p-6 text-white shadow-xl shadow-brand-500/20 relative overflow-hidden">
            ...
            return (
              <button
                ...
                className={`p-2.5 pb-3 rounded-2xl border flex flex-col items-center min-w-[88px] transition-all ${
                  isSelected
                    ? 'border-brand-600 bg-brand-50/80 shadow-md scale-105 ring-2 ring-brand-500/20'
      ...
      {currentStudent && (
        <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-5">
      ...
      {analysis && (
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden animate-in fade-in slide-in-from-bottom duration-300 space-y-6 p-5 sm:p-7">
          ...
          <div className="flex flex-col sm:flex-row justify-between sm:items-center pb-5 border-b border-slate-100 gap-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-brand-100 text-brand-700 flex items-center justify-center text-xl font-bold shrink-0">
                🎖️
              </div>
              <div>
          ...
          <div className="p-5 rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 text-white space-y-3">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                <Button variant="ghostDark" size="sm" onClick={handleCopyLetter}>
                  {copied ? <Check className="w-3.5 h-3.5 text-emerald-400" /> : <Copy className="w-3.5 h-3.5" />}
                  {copied ? 'Kopyalandı' : 'Mektubu Kopyala'}
                </Button>

                <Button variant="primary" size="sm" onClick={handleSendToParent}>
